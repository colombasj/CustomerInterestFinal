...
public class Deluxe extends Savings implements Compunt_Interest {
    public Deluxe(String customerNo, String name, double amount, int noofyears, String typeofSaving) {
    ...
    public void generateTable() {
        ...
        {
            Double interest = (startingamt * 15)/100 ;
